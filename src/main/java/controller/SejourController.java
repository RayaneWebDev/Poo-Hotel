...
public class SejourController {
    ...
    public void chargerSejours() {
            ...
            for (Sejour sejour : sejours) {
                Client client = trouverClientParReservation(sejour.getReservation());
                view.ajouterSejourDansTable(sejour, client);
            }
    ...
    public Client trouverClientParReservation(model.Reservation reservation) {
